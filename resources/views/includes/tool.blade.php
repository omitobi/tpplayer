    ...
    <div class="row" id="now_playing">
        <div>
            <table class="table">
                ...
                <tr>
                    <td colspan="2" align="center"><a href="" class="btn btn-info">Add to a Playlist</a></td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <span class="input-group-btn">
                    <a href="" id="_new_music_add_btn" class="btn-sm btn-default"><i class="glyphicon glyphicon-plus-sign alert-danger"></i></a>
                </span>
                                </div>
                            </div>
                            </form>
